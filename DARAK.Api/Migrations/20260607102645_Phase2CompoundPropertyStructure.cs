...
{
    /// <inheritdoc />
    public partial class Phase2CompoundPropertyStructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingSpots_Compounds_CompoundId",
                        column: x => x.CompoundId,
                        principalTable: "Compounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Floors_Compounds_CompoundId",
                        column: x => x.CompoundId,
                        principalTable: "Compounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaSquareMeters = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyUnits_Compounds_CompoundId",
                        column: x => x.CompoundId,
                        principalTable: "Compounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buildings_CompoundId_Code",
                table: "Buildings",
                columns: new[] { "CompoundId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Compounds_Code",
                table: "Compounds",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Floors_CompoundId",
                table: "Floors",
                column: "CompoundId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingSpots_CompoundId_SpotNumber",
                table: "ParkingSpots",
                columns: new[] { "CompoundId", "SpotNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PropertyUnits_BuildingId",
                table: "PropertyUnits",
                column: "BuildingId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyUnits_CompoundId_BuildingId_UnitNumber",
                table: "PropertyUnits",
                columns: new[] { "CompoundId", "BuildingId", "UnitNumber" },
                unique: true);
