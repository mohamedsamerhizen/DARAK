...
{
    /// <inheritdoc />
    public partial class Phase3ResidentsOccupancy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResidentProfiles_Compounds_CompoundId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OccupancyRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OccupancyRecords_Compounds_CompoundId",
                        column: x => x.CompoundId,
                        principalTable: "Compounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OccupancyRecords_PropertyUnits_PropertyUnitId",
                        column: x => x.PropertyUnitId,
                        principalTable: "PropertyUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OccupancyRecords_ResidentProfiles_ResidentProfileId",
                        column: x => x.ResidentProfileId,
                        principalTable: "ResidentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OccupancyRecords_CompoundId",
                table: "OccupancyRecords",
                column: "CompoundId");

            migrationBuilder.CreateIndex(
                name: "IX_OccupancyRecords_PropertyUnitId",
                table: "OccupancyRecords",
                column: "PropertyUnitId",
                unique: true,
                filter: "[OccupancyStatus] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_OccupancyRecords_ResidentProfileId",
                table: "OccupancyRecords",
                column: "ResidentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ResidentProfiles_CompoundId",
                table: "ResidentProfiles",
                column: "CompoundId");

            migrationBuilder.CreateIndex(
                name: "IX_ResidentProfiles_UserId_CompoundId",
                table: "ResidentProfiles",
                columns: new[] { "UserId", "CompoundId" },
                unique: true);
        }
